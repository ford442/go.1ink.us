  ...
  return (
    ...
    >
      {paginatedProjects.map((project, index) => (
        <div
          key={project.id}
          className={`animate-card-enter hover:scale-[1.02] ${displayMode === 'grid' ? 'break-inside-avoid inline-block w-full mb-6 md:mb-8' : ''} transition-all duration-700 ease-[cubic-bezier(0.19,1,0.22,1)] ${
