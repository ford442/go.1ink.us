...
export default function TerminalBar() {
  ...
  {(isTerminalOpen || isTerminalClosing) && (
    <div
      className={`fixed bottom-0 left-0 right-0 z-[200] bg-black/95 backdrop-blur-xl border-t border-accent-500/50 p-4 font-mono text-sm shadow-[0_-10px_40px_rgba(var(--rgb-accent-400),0.15)] flex flex-col transform-gpu terminal-modal ${isTerminalClosing ? 'animate-slide-out-down' : 'animate-slide-in-up'}`}
      role="region"
    ...
    >
       ...
       <div className="flex-1 overflow-y-auto max-h-[30vh] min-h-[150px] mb-3 space-y-1.5 scrollbar-hide pr-2" role="log" aria-live="polite" aria-relevant="additions">
       ...
       <form onSubmit={handleTerminalSubmit} className="relative flex items-center group">
          ...
          <div className="relative flex-1">
             ...
             <input
               ...
               className="w-full bg-transparent border-none outline-none text-white focus:ring-0 p-0 placeholder-gray-400 relative z-10 font-mono"
