...
const AudioVisualizer = ({ theme }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center border-l border-accent-500/30 pl-4 ml-2" aria-hidden="true">
      <div className="flex justify-between w-full mb-1">
        <span className="opacity-50 text-xs font-mono text-accent-200/90 mr-2">AUDIO:</span>
