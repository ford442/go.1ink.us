...
export default function BackgroundElements() {
  ...
  return (
    <>
      <div className={`fixed inset-0 overflow-hidden pointer-events-none transition-all duration-700 ${showWarpFx ? 'opacity-30 blur-sm scale-110' : 'opacity-100 scale-100'}`} aria-hidden="true">
        {flags.starfield && (
          <div style={{
